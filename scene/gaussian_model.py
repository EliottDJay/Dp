...
class GaussianModel:
    ...
    def __init__(self, sh_degree : int):
        ...
        self.divide_ratio = 0.8
        self.model_vertion = 1
        self.opecity_correction = opecity_correction
    ...
    def reset_pc_model(self, version=None):
        if version is not None:
            self.model_vertion = version
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, N=2, store_grads=False, abe_split=False):
    ...
    def densify_and_prune(self, max_grad, min_opacity, extent, max_screen_size, N=2, state_dict=None, store_grads=False, abe_split=False):
        ...
        n_points_split = self.densify_and_split(grads, max_grad, extent, N=N, store_grads=store_grads, abe_split=abe_split)

        
        self.prune(min_opacity, extent, max_screen_size, state_dict, store_grads=store_grads)
    ...
    def prune(self, min_opacity, extent, max_screen_size, state_dict, store_grads=False):
